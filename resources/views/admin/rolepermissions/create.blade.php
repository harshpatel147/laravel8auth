      ...
      <div class="container-fluid">
        <div class="col-md-8 offset-2">
          ...
          <div class="card card-primary">
            ...
            <!-- /.card-header -->
            <!-- form start -->
            <form action="{{ route('admin.rolepermissions.store') }}" method="POST">
              @csrf
              ...
              <div class="card-body">
                  ...
                  <select class="select2" name="role_id" data-placeholder="Select a State" style="width: 100%;">
                      @foreach ($roles as $value)
                          <option value="{{ $value->id }}"
                            <?php if(in_array($value->id, $roleexits)){ echo "disabled";}?> > {{ $value->id }}{{ $value->rolename }} </option>
                      @endforeach
                  </select>
                </div>
                ...
                <div class="form-group">
                  ...
                  <select class="select2" multiple="multiple" name="permission_id[]" data-placeholder="Select Permissions" style="width: 100%;">
